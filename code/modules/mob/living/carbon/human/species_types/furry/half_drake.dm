/mob/living/carbon/human/species/half_drake
	race = /datum/species/half_drake

/datum/species/half_drake
	name = "Half-Drake"
	id = "half_drake"
	desc = "<b>Half-Drake</b><br>\
	Hybrid descendants of drakians and other races, bearing diluted but still potent draconic heritage.<br>\
	(+1 Strength)"
	...
	customizers = list(
		...
		/datum/customizer/organ/tail/half_drake,
...
/datum/species/half_drake/check_roundstart_eligible()
	return TRUE

/datum/species/half_drake/qualifies_for_rank(rank, list/features)
	return TRUE

/datum/species/half_drake/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	..()
	RegisterSignal(C, COMSIG_MOB_SAY, PROC_REF(handle_speech))

/datum/species/half_drake/on_species_loss(mob/living/carbon/C)
	. = ..()
	UnregisterSignal(C, COMSIG_MOB_SAY)

/datum/species/half_drake/get_random_body_markings(list/passed_features)
...
/datum/species/half_drake/get_random_features()
